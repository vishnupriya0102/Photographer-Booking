  ...
  return (
    <div>
      <div className="mb-[50px]">
        <h4 className="text-[20px] leading-[30px] font-bold text-headingColor1 mb-[30px]">
        ...
        { reviews?.map((review, index)=>( <div key={index} className="flex justify-between gap-10 mb-[30px]">
          ...
          <div >
            ...
            <p className="text-[14px] leading-6 text-textColor1">
              {formateDate(review?.createdAt)}
            </p>
            <p className="text__para1 mt-3 font-medium text-[15px]">
              {review.reviewText}
            </p>
            </div>
          </div>
